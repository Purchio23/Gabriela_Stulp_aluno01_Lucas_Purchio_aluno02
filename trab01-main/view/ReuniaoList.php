...
include "../controller/ReuniaoController.php";
  ...
  if(!empty($_GET['id'])){
    $Reuniao->deletar($_GET['id']);
    header("location: ReuniaoList.php");
  }
  if(!empty($_POST)){
    $load = $Reuniao->pesquisar($_POST);

  }else{
    $load = $Reuniao->carregar();
...
<html lang="en">
 ...
 <br>
    ...
    <form action="ReuniaoList.php" method="post">
  ...
  <div class="col-6">
      ...
      <a class="btn btn-primary"href="ReuniaoForm.php"><i class="fa-solid fa-plus"></i> Cadastrar</a>
  </div>
  ...
  <thead>
    ...
    foreach($load as $item){
      echo"<tr>
            ...
            <td><a href='./ReuniaoForm.php?id=$item->id'><i class='fa-solid fa-pen-to-square'></i></a></td>
            <td><a href='./ReuniaoList.php?id=$item->id'
